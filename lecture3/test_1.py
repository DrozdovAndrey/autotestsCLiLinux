...
class TestPositive:
    def test_step1(self, make_folders, clear_folders, make_files):
        # test1
        res1 = checkout(f"cd {data['folder_in']}; 7z a {data['type']} {data['folder_out']}/arx", "Everything is Ok")
    ...
    def test_step2(self, clear_folders, make_files):
        # test2
        res = list()
        res.append(checkout(f"cd {data['folder_in']}; 7z a {data['type']} {data['folder_out']}/arx", "Everything is Ok"))
        res.append(
